...
# Detection
def object_detection_function(command, chooseColor_array):
    ...
    with detection_graph.as_default():
        with tf.compat.v1.Session(graph=detection_graph) as sess:
            ...
            while cap.isOpened():
                ...
                cv2.putText(
                    input_frame,
                    'Carros {}: '.format(chooseColor_array[2]) + str(total_passed_vehicle),
                    (10, 35),
                    font,
                    0.8,
                    (0, 0xFF, 0xFF),
...
print(corEscolhida)
object_detection_function(args.command, corEscolhida)		
